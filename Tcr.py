...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye all","Kabur kuy"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
         ...
         #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Greet","Sikat kuy" in msg.text:
              if msg.from_ in Bots:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Greet","Sikat kuy")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Responsename","respon","Respon Dong","respon dong"]:
                cl.sendText(msg.to)
                ki.sendText(msg.to)
                kk.sendText(msg.to)
                kc.sendText(msg.to)
